    ...
    try:
        ...
        try:
            ...
            try:
                ...
                print("Linux: No real-time GPU monitoring available (no nvidia-smi, rocm-smi, or working drivers)")
...
while True:
    try:
        ...
        vm_gpu_info = get_vm_gpu_memory_info()
        ...
        gpu_pid_util, gpu_pid_mem = get_gpu_process_stats()
