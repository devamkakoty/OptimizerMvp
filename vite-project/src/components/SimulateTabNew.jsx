    ...
    <div className="main">
      ...
      <div className="simulate-form-grid">
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-2 py-1.5 border border-gray-300 dark:border-gray-600 rounded-md text-gray-900 dark:text-white bg-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm"
      ...
      <div className="mt-4 flex justify-end gap-2">
        <button 
          ...
          className="px-3 py-1.5 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white text-sm font-medium rounded-md transition-colors btn4"
        >
          {isRunningSimulation ? (
            <div className="flex items-center gap-2">
        ...
        <button 
          onClick={() => {
            // Demo results functionality - you can implement this
            console.log('Demo Results clicked');
          }}
          className="px-3 py-1.5 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-md transition-colors btn5"
        >
          Demo Results
        </button>
      </div>
