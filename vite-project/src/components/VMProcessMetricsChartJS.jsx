...
const VMProcessMetricsChartJS = () => {
  ...
  const fetchVMProcessMetrics = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:8000/api/v1/metrics/vm/${selectedVM}/processes?limit=20`
      );
  ...
  const cpuChartData = {
    labels: aggregatedData.map(item => item.process_name),
    datasets: [
      {
        label: 'CPU Usage (%)',
        data: aggregatedData.map(item => item.avg_cpu),
    ...
    datasets: [
      {
        ...
        data: aggregatedData.map(item => item.avg_memory),
        ...
        {selectedVM && vmProcessData.length > 0 && (
          <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-purple-50 dark:bg-purple-900/30 p-4 rounded-lg">
              <div className="text-sm text-purple-600 dark:text-purple-400 font-medium">Total Power</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
              ...
              <div style={{ height: '300px' }}>
                <Bar data={cpuChartData} options={chartOptions} />
              </div>
            </div>
...
export default VMProcessMetricsChartJS;