...
const FinOpsTab = () => {
  ...
  const fetchCostSummary = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:8000/api/costs/process-summary?${params}`);
  ...
  const fetchRecommendations = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:8000/api/recommendations/cross-region?${params}`);
      const data = await response.json();
  ...
  const fetchTopProcesses = async () => {
    try {
      const response = await fetch(`http://localhost:8000/api/recommendations/top-energy-processes?time_range_days=${timeRange}&limit=10`);
      const data = await response.json();
  ...
  const fetchRegionalPricing = async () => {
    try {
      const response = await fetch('http://localhost:8000/api/recommendations/regional-pricing');
      const data = await response.json();
  ...
  const fetchCostTrends = async () => {
    try {
      ...
      const response = await fetch(`http://localhost:8000/api/costs/trends?${params}`);
      const data = await response.json();
