...
import { Search, Plus, Edit, Trash2, Brain, BarChart3, Database, Activity } from 'lucide-react';
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">AI Model Management</h2>
              <p className="text-gray-600 dark:text-gray-400">Manage your AI models database</p>
            </div>
          </div>
          <button
            onClick={() => {
            ...
            className="flex items-center space-x-2 px-4 py-2 bg-[#01a982] text-white rounded-lg hover:bg-[#019670] transition-colors"
          >
        ...
        {statistics && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-gradient-to-r from-[#ecfdf5] to-[#f0fdf4] dark:from-[#064e3b] dark:to-[#065f46] p-4 rounded-lg">
              <div className="flex items-center">
                <BarChart3 className="w-8 h-8 text-[#01a982] dark:text-[#34d399] mr-3" />
                <div>
                  <div className="text-2xl font-bold text-[#01a982] dark:text-[#ecfdf5]">
                    {statistics.frameworks?.length || 0}
                  </div>
                  <div className="text-sm text-[#047857] dark:text-[#6ee7b7]">Frameworks</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-[#ecfdf5] to-[#f0fdf4] dark:from-[#064e3b] dark:to-[#065f46] p-4 rounded-lg">
              <div className="flex items-center">
                <Activity className="w-8 h-8 text-[#01a982] dark:text-[#34d399] mr-3" />
                <div>
                  <div className="text-2xl font-bold text-[#01a982] dark:text-[#ecfdf5]">
                    {statistics.task_types?.length || 0}
                  </div>
                  <div className="text-sm text-[#047857] dark:text-[#6ee7b7]">Task Types</div>
                </div>
              </div>
            </div>
            
            <div className="bg-gradient-to-r from-orange-50 to-orange-100 dark:from-orange-900 dark:to-orange-800 p-4 rounded-lg">
              <div className="flex items-center">
                <Brain className="w-8 h-8 text-orange-600 dark:text-orange-400 mr-3" />
                <div>
                  <div className="text-2xl font-bold text-orange-900 dark:text-orange-100">
                    {statistics.architecture_types?.length || 0}
                  </div>
                  <div className="text-sm text-orange-700 dark:text-orange-300">Architectures</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Search models by name, framework, task type, or architecture..."
            value={searchTerm}
            onChange={(e) => setSearchTerm(e.target.value)}
            className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-[#01a982] focus:border-[#01a982]"
          />
        </div>
      </div>
