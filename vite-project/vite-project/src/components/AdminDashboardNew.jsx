...
const AdminDashboardNew = ({ 
  ...
  const performanceMetrics = [
    ...
    { label: 'Network', value: hostMetrics?.host_network_usage_percent || 0, unit: '%', color: 'yellow' },
    { label: 'Disk I/O', value: hostMetrics?.host_disk_usage_percent || 0, unit: '%', color: 'red' },
  ];
        ...
        <div class="section">
          ...
          <div class="grid">
            ...
            <div class="card">
              ...
              <div class="metric"><strong>Usage:</strong> ${hostMetrics?.host_disk_usage_percent ? `${hostMetrics.host_disk_usage_percent.toFixed(1)}%` : 'N/A'}</div>
            </div>
          </div>
        </div>
